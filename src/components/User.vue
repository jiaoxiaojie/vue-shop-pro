      ...
      <el-table :data="userInfos" border style="width: 100%">
        ...
        <el-table-column label="操作" width="230">
          <template slot-scope="info">
            <el-button type="primary" icon="el-icon-edit" circle @click="showEditDialog(info.row.id)"></el-button>
...
export default {
  ...
  data() {
    ...
    var checkMobile = (rule, value, callback) => {
      // 手机号码规则：1开始，后接3|5|8|9|7,在后面跟9位数字
      // 正则表达式校验
    ...
    return {
      ...
      addFormRules: {
        ...
        // 制作自定义手机号码表单校验规则 { validator: checkAge校验函数, trigger: 'blur' }
        mobile: [
          { required: true, message: '手机号码必填', trigger: 'blur' },
          { validator: checkMobile, trigger: 'blur' }
        ]
